...
import { LocationSearchMapTopAllCentered } from '@/components/location-search/LocationSearchMapTopAllCentered.dev';
...
describe('LocationSearchMapTopAllCentered', () => {
  beforeEach(() => {
    process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY = 'test-api-key';
  });

  it('renders component with title', () => {
    const { getByText } = render(<LocationSearchMapTopAllCentered {...mockLocationSearchProps} />);
