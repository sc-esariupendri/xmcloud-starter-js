...
import { LocationSearchMapRightTitleZipCentered } from '@/components/location-search/LocationSearchMapRightTitleZipCentered.dev';
...
describe('LocationSearchMapRightTitleZipCentered', () => {
  beforeEach(() => {
