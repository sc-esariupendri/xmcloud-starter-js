...
import { HeroImageBackground } from '@/components/hero/HeroImageBackground.dev';
...
describe('HeroImageBackground Component', () => {
  beforeEach(() => {
  ...
  it('renders with background image layout', () => {
  ...
  it('renders zipcode search form and banner overlay', () => {
    render(<HeroImageBackground {...mockHeroProps} />);
