...
import { HeroImageBottom } from '@/components/hero/HeroImageBottom.dev';
...
describe('HeroImageBottom Component', () => {
  beforeEach(() => {
  ...
  it('renders with image at bottom layout', () => {
  ...
  it('displays content sections in correct order', () => {
    render(<HeroImageBottom {...mockHeroProps} />);
  ...
  it('renders banner at bottom with secondary variant button', () => {
    render(<HeroImageBottom {...mockHeroProps} />);
