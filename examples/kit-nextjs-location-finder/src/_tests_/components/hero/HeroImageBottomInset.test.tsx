...
import { HeroImageBottomInset } from '@/components/hero/HeroImageBottomInset.dev';
...
describe('HeroImageBottomInset Component', () => {
  beforeEach(() => {
  ...
  it('renders with inset image layout', () => {
  ...
  it('displays all content elements', () => {
    render(<HeroImageBottomInset {...mockHeroProps} />);
  ...
  it('renders banner overlay on image with default variant button', () => {
    render(<HeroImageBottomInset {...mockHeroProps} />);
