...
import { ImageGalleryGrid } from '@/components/image-gallery/ImageGalleryGrid.dev';
...
describe('ImageGalleryGrid Component', () => {
  it('renders with 2x2 grid layout', () => {
    const { container } = render(<ImageGalleryGrid {...mockImageGalleryProps} />);
  ...
  it('displays centered header with title and description', () => {
    render(<ImageGalleryGrid {...mockImageGalleryProps} />);
