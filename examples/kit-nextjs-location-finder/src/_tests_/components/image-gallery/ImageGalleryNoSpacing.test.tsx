...
import { ImageGalleryNoSpacing } from '@/components/image-gallery/ImageGalleryNoSpacing.dev';
...
describe('ImageGalleryNoSpacing Component', () => {
  it('renders with no spacing layout', () => {
    const { container } = render(<ImageGalleryNoSpacing {...mockImageGalleryProps} />);
  ...
  it('displays title and description with dark theme', () => {
    render(<ImageGalleryNoSpacing {...mockImageGalleryProps} />);
  ...
  it('disables parallax effects for reduced motion preference', () => {
