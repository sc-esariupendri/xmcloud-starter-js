...
import { ImageGalleryFiftyFifty } from '@/components/image-gallery/ImageGalleryFiftyFifty.dev';
...
describe('ImageGalleryFiftyFifty Component', () => {
  it('renders with 50/50 split layout', () => {
    const { container } = render(<ImageGalleryFiftyFifty {...mockImageGalleryProps} />);
  ...
  it('displays title and description in left column', () => {
    render(<ImageGalleryFiftyFifty {...mockImageGalleryProps} />);
  ...
  it('shows accessibility notice for reduced motion', () => {
